                ...
                <tr>
                    ...
                    <td class="action-cell">
                        <c:if test="${apply.status == 'pending'}">
                            <a href="<%= request.getContextPath() %>/memberApply/approve?id=${apply.id}&clubId=${clubId}">
                                <button class="btn btn-approve">通过</button>
                            </a>
                            <a href="<%= request.getContextPath() %>/memberApply/reject?id=${apply.id}&clubId=${clubId}">
