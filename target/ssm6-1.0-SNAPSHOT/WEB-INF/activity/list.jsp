...
<%
    ...
    if (userInfo != null && "student".equals(((com.zwj.entity.User)userInfo).getRole())) {
%>
            <a href="<%= request.getContextPath() %>/activityApply/myApplies" class="btn btn-info">📋 我的报名</a>
<%
    }
%>
    ...
    %>
                ...
                %>
                                ...
                                <a href="<%= request.getContextPath() %>/activityApply/list?activityId=<%= activity.getId() %>" class="btn btn-info">📝 报名列表</a>
                <%
                            } else if (userInfo != null && "student".equals(((com.zwj.entity.User)userInfo).getRole())) {
                %>
                                <a href="<%= request.getContextPath() %>/activityApply/apply?activityId=<%= activity.getId() %>" 
                                   class="btn btn-success"
                                   onclick="return confirm('确定要报名这个活动吗？')">✅ 活动报名</a>
                <%
                            } else {
                %>
