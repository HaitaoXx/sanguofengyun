...
%>
                    ...
                    <a href="<%= request.getContextPath() %>/statistics" class="menu-card admin-card">
                        <div class="menu-icon">📊</div>
                        <div class="menu-title">数据统计</div>
                        <div class="menu-description">查看系统数据统计和可视化报表</div>
                    </a>
<%      } else if ("leader".equals(userInfo.getRole())) {
%>
                    ...
                    <a href="<%= request.getContextPath() %>/statistics" class="menu-card leader-card">
                        <div class="menu-icon">📊</div>
                        <div class="menu-title">数据统计</div>
                        <div class="menu-description">查看社团数据统计和可视化报表</div>
                    </a>
<%      } else if ("student".equals(userInfo.getRole())) {
%>
