...
<div class="container">
    ...
    <div class="button-group">
        ...
        %>
            <a href="<%= request.getContextPath() %>/memberApply/myApplies" class="btn btn-info">📋 我的申请</a>
        <%
            }
            if (userInfo != null && ("admin".equals(((com.zwj.entity.User)userInfo).getRole()) || "leader".equals(((com.zwj.entity.User)userInfo).getRole()))) {
        %>
            <a href="<%= request.getContextPath() %>/memberApply/list" class="btn btn-info">📝 申请列表</a>
        <%
            }
        %>
    ...
    <tr>
        ...
        <td>
            ...
            %>
                <a href="<%= request.getContextPath() %>/memberApply/apply?clubId=<%= club.getId() %>" 
                   class="btn btn-success"
                   onclick="return confirm('确定要申请加入这个社团吗？')">✅ 申请加入</a>
            <%
                } else {
            %>
