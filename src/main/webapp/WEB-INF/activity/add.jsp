...
<body>
    ...
    <div class="container">
        ...
        <div class="form-card">
            <form action="<%= request.getContextPath() %>/activity/add" method="post">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" required placeholder="请输入活动名称">
                    </div>
                    
                    <div class="form-group">
                        <label for="location">活动地点:</label>
                        <input type="text" name="location" id="location" required placeholder="请输入活动地点">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="duration" id="duration" min="0.5" step="0.5" placeholder="2.0">
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="description">活动描述:</label>
                    <textarea name="description" id="description" required placeholder="请详细描述活动内容、安排等信息..."></textarea>
                </div>
